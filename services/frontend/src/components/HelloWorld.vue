    ...
    <v-layout>
      <v-navigation-drawer
        ...
        <v-list nav>
          ...
          <v-list-item class="opacity-80 bg-blue-accent-4 text-white" prepend-icon="mdi-plus" title="Create new case" value="create-new-case"></v-list-item>
        </v-list>
      </v-navigation-drawer>
...
export default {
  ...
  data: () => ({
      items: [
        ...
        { title: 'Statistics', icon: 'question_answer'},
